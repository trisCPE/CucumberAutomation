...
public abstract class BasePage {
    ...
    /**
     * A base constructor that sets the pages's driver
     *
     * The pages structure is being used within this test in order to separate the
     * pages actions from the tests.
     *
     * Please use the AppiumFieldDecorator class within the pages factory. This way annotations
     * like @AndroidFindBy within the pages objects.
     *
